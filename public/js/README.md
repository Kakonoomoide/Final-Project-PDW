...
- `planner.js` — halaman `/planner`: form preferensi, daftar rencana,
  tombol geolocation
- `trip-map.js` — halaman `/trip/:id`: itinerary per hari + peta Leaflet
- `chat.js` — halaman `/chat`: kirim pesan, render riwayat, dan kompres
  foto di browser sebelum diupload
